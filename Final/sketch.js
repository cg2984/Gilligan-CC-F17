...
function back(){
	//removed previous position marker	
...
function forward () {
	//removes theprevious position number
...
function gotSearch(tempData2){
	...
	else if (aVal == 100 | aVal > 100){
		button[2].hide();
	}
	else {
		console.log("not 0  or not 100 picture");
	}
